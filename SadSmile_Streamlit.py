...
if selected == "About Me": 
    ...
    with col2:  
        st.write("Hello! My name is Edmond Anderson and I am a second year in the Masters of Data Science program at Michigan State University. I got my undergraduate degrees in Mathematics and Psychology, and I am interested in the ways humans experience computers, and the ways computers experience humans. Specifically, I am curious about the ways in which Artificial Intellegence can understand and manipulate human emotions, as well as the ethically behind such applications of machine learning. I am also interested in studying the ways in which recommender systems and generative models can alter and affect human behavior and beliefs. I currently work in the Shiu Lab here at MSU, where I study applications of topic modeling and knowledge graphs on very large scale datasets.")  
