...
def main():
   ...
   # datagen.fit(train_generator)
    ...
    checkpoint_filepath = 'output/checkpoint.model.keras'
    ...
    best_model.fit(train_generator, validation_data=val_generator, epochs=40, callbacks=[model_checkpoint_callback])
   

   
    #with open(OUTPUT_DIR / 'trainingGenVGG19.pickle', "wb") as f:
      # pickle.dump(train_generator, f)
    best_model.save(OUTPUT_DIR / 'Resnet50m1odel.h5')
   
    with open(OUTPUT_DIR / 'Resnet50m1model.pickle', "wb") as f:
